...
DEFAULT_SELECTED_ROBUSTNESS_RULES: dict[str, SelectedExecutionRobustnessRule] = {
    ...
    TOTAL_GOALS_DISTRIBUTION_HGB_CONFIRMED_UNDER_HIGH_300_V1_KEY: SelectedExecutionRobustnessRule(
        strategy_key=TOTAL_GOALS_DISTRIBUTION_HGB_CONFIRMED_UNDER_HIGH_300_V1_KEY,
        primary_target=10,
        min_seen_count=4,
        min_edge=Decimal("0.0000"),
        allow_bucket_changed=False,
        allow_line_changed=False,
        require_side_unchanged=True,
    ),
    TOTAL_GOALS_DISTRIBUTION_HGB_CONFIRMED_OVER_MID_250_V1_KEY: SelectedExecutionRobustnessRule(
    ...
    TOTAL_GOALS_HGB_CONFIRMED_UNDER_LOW_225_V1_KEY: SelectedExecutionRobustnessRule(
        strategy_key=TOTAL_GOALS_HGB_CONFIRMED_UNDER_LOW_225_V1_KEY,
        primary_target=10,
        min_seen_count=2,
        min_edge=Decimal("0.0400"),
        allow_bucket_changed=True,
        allow_line_changed=True,
        require_side_unchanged=True,
    ),
