...
class TrainingRun(Base):
    ...
    total_goals_edge_stability_report_path: Mapped[str | None] = mapped_column(String(255))
    total_goals_bucket_sandbox_report_path: Mapped[str | None] = mapped_column(String(255))
