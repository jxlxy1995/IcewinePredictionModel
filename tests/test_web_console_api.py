...
def test_web_app_starts_and_stops_paper_automation_scheduler_with_env_config(
    ...
    monkeypatch.setenv("PAPER_AUTOMATION_RUNNING_TIMEOUT_MINUTES", "invalid")
...
def test_web_console_api_batch_records_skip_duplicate_paper_candidates(tmp_path):
    ...
    assert batch_result["snapshot_ids"]
    assert {
        key: value
...
def test_web_console_api_syncs_filtered_zqcf918_match_ids(tmp_path):
    ...
    def fake_zqcf918_match_id_syncer(match_ids):
        ...
        return {
            "success": [{"match_id": match_id, "message": "matched", "source_fixture_id": "4460916"}],
            "failed": [],
            "skipped": [],
            "requests": 1,
            "credits": 0,
